...
static til::static_map xorgAppColorTable {
    ...
    std::pair{ L"lemon chiffon"sv, til::color{ 255, 250, 205 } },
    ...
    std::pair{ L"dark slate gray"sv, til::color{ 47, 79, 79 } },
    std::pair{ L"darkslategray"sv, til::color{ 47, 79, 79 } },
    std::pair{ L"dark slate grey"sv, til::color{ 47, 79, 79 } },
    std::pair{ L"darkslategrey"sv, til::color{ 47, 79, 79 } },
    std::pair{ L"dim gray"sv, til::color{ 105, 105, 105 } },
    std::pair{ L"dimgray"sv, til::color{ 105, 105, 105 } },
    std::pair{ L"dim grey"sv, til::color{ 105, 105, 105 } },
    std::pair{ L"dimgrey"sv, til::color{ 105, 105, 105 } },
    std::pair{ L"slate gray"sv, til::color{ 112, 128, 144 } },
    std::pair{ L"slategray"sv, til::color{ 112, 128, 144 } },
    std::pair{ L"slate grey"sv, til::color{ 112, 128, 144 } },
    std::pair{ L"slategrey"sv, til::color{ 112, 128, 144 } },
    std::pair{ L"light slate gray"sv, til::color{ 119, 136, 153 } },
    std::pair{ L"lightslategray"sv, til::color{ 119, 136, 153 } },
    std::pair{ L"light slate grey"sv, til::color{ 119, 136, 153 } },
    ...
    std::pair{ L"x11 gray"sv, til::color{ 190, 190, 190 } },
    std::pair{ L"x11gray"sv, til::color{ 190, 190, 190 } },
    std::pair{ L"x11 grey"sv, til::color{ 190, 190, 190 } },
    std::pair{ L"x11grey"sv, til::color{ 190, 190, 190 } },
    std::pair{ L"web gray"sv, til::color{ 128, 128, 128 } },
    std::pair{ L"webgray"sv, til::color{ 128, 128, 128 } },
    std::pair{ L"web grey"sv, til::color{ 128, 128, 128 } },
    std::pair{ L"webgrey"sv, til::color{ 128, 128, 128 } },
    std::pair{ L"light grey"sv, til::color{ 211, 211, 211 } },
    std::pair{ L"lightgrey"sv, til::color{ 211, 211, 211 } },
    std::pair{ L"light gray"sv, til::color{ 211, 211, 211 } },
    std::pair{ L"lightgray"sv, til::color{ 211, 211, 211 } },
    std::pair{ L"midnight blue"sv, til::color{ 25, 25, 112 } },
    std::pair{ L"midnightblue"sv, til::color{ 25, 25, 112 } },
    std::pair{ L"navy"sv, til::color{ 0, 0, 128 } },
    std::pair{ L"navy blue"sv, til::color{ 0, 0, 128 } },
    std::pair{ L"navyblue"sv, til::color{ 0, 0, 128 } },
    std::pair{ L"cornflower blue"sv, til::color{ 100, 149, 237 } },
    std::pair{ L"cornflowerblue"sv, til::color{ 100, 149, 237 } },
    std::pair{ L"dark slate blue"sv, til::color{ 72, 61, 139 } },
    std::pair{ L"darkslateblue"sv, til::color{ 72, 61, 139 } },
    std::pair{ L"slate blue"sv, til::color{ 106, 90, 205 } },
    std::pair{ L"slateblue"sv, til::color{ 106, 90, 205 } },
    std::pair{ L"medium slate blue"sv, til::color{ 123, 104, 238 } },
    std::pair{ L"mediumslateblue"sv, til::color{ 123, 104, 238 } },
    std::pair{ L"light slate blue"sv, til::color{ 132, 112, 255 } },
    std::pair{ L"lightslateblue"sv, til::color{ 132, 112, 255 } },
    std::pair{ L"medium blue"sv, til::color{ 0, 0, 205 } },
    std::pair{ L"mediumblue"sv, til::color{ 0, 0, 205 } },
    std::pair{ L"royal blue"sv, til::color{ 65, 105, 225 } },
    std::pair{ L"royalblue"sv, til::color{ 65, 105, 225 } },
    std::pair{ L"blue"sv, til::color{ 0, 0, 255 } },
    std::pair{ L"dodger blue"sv, til::color{ 30, 144, 255 } },
    std::pair{ L"dodgerblue"sv, til::color{ 30, 144, 255 } },
    std::pair{ L"deep sky blue"sv, til::color{ 0, 191, 255 } },
    std::pair{ L"deepskyblue"sv, til::color{ 0, 191, 255 } },
    std::pair{ L"sky blue"sv, til::color{ 135, 206, 235 } },
    std::pair{ L"skyblue"sv, til::color{ 135, 206, 235 } },
    std::pair{ L"light sky blue"sv, til::color{ 135, 206, 250 } },
    std::pair{ L"lightskyblue"sv, til::color{ 135, 206, 250 } },
    std::pair{ L"steel blue"sv, til::color{ 70, 130, 180 } },
    std::pair{ L"steelblue"sv, til::color{ 70, 130, 180 } },
    std::pair{ L"light steel blue"sv, til::color{ 176, 196, 222 } },
    std::pair{ L"lightsteelblue"sv, til::color{ 176, 196, 222 } },
    std::pair{ L"light blue"sv, til::color{ 173, 216, 230 } },
    std::pair{ L"lightblue"sv, til::color{ 173, 216, 230 } },
    std::pair{ L"powder blue"sv, til::color{ 176, 224, 230 } },
    std::pair{ L"powderblue"sv, til::color{ 176, 224, 230 } },
    std::pair{ L"pale turquoise"sv, til::color{ 175, 238, 238 } },
    std::pair{ L"paleturquoise"sv, til::color{ 175, 238, 238 } },
    std::pair{ L"dark turquoise"sv, til::color{ 0, 206, 209 } },
    std::pair{ L"darkturquoise"sv, til::color{ 0, 206, 209 } },
    std::pair{ L"medium turquoise"sv, til::color{ 72, 209, 204 } },
    ...
    std::pair{ L"light goldenrod"sv, til::color{ 238, 221, 130 } },
    std::pair{ L"lightgoldenrod"sv, til::color{ 238, 221, 130 } },
    std::pair{ L"goldenrod"sv, til::color{ 218, 165, 32 } },
    std::pair{ L"dark goldenrod"sv, til::color{ 184, 134, 11 } },
    std::pair{ L"darkgoldenrod"sv, til::color{ 184, 134, 11 } },
    std::pair{ L"rosy brown"sv, til::color{ 188, 143, 143 } },
    std::pair{ L"rosybrown"sv, til::color{ 188, 143, 143 } },
    std::pair{ L"indian red"sv, til::color{ 205, 92, 92 } },
    std::pair{ L"indianred"sv, til::color{ 205, 92, 92 } },
    std::pair{ L"saddle brown"sv, til::color{ 139, 69, 19 } },
    ...
    std::pair{ L"sandy brown"sv, til::color{ 244, 164, 96 } },
    ...
    std::pair{ L"medium orchid"sv, til::color{ 186, 85, 211 } },
    std::pair{ L"mediumorchid"sv, til::color{ 186, 85, 211 } },
    std::pair{ L"dark orchid"sv, til::color{ 153, 50, 204 } },
    std::pair{ L"darkorchid"sv, til::color{ 153, 50, 204 } },
    std::pair{ L"dark violet"sv, til::color{ 148, 0, 211 } },
    std::pair{ L"darkviolet"sv, til::color{ 148, 0, 211 } },
    std::pair{ L"blue violet"sv, til::color{ 138, 43, 226 } },
    std::pair{ L"blueviolet"sv, til::color{ 138, 43, 226 } },
    std::pair{ L"purple"sv, til::color{ 160, 32, 240 } },
    std::pair{ L"x11 purple"sv, til::color{ 160, 32, 240 } },
    std::pair{ L"x11purple"sv, til::color{ 160, 32, 240 } },
    std::pair{ L"web purple"sv, til::color{ 128, 0, 128 } },
    std::pair{ L"webpurple"sv, til::color{ 128, 0, 128 } },
    std::pair{ L"medium purple"sv, til::color{ 147, 112, 219 } },
    ...
    std::pair{ L"dark grey"sv, til::color{ 169, 169, 169 } },
    std::pair{ L"darkgrey"sv, til::color{ 169, 169, 169 } },
    std::pair{ L"dark gray"sv, til::color{ 169, 169, 169 } },
    std::pair{ L"darkgray"sv, til::color{ 169, 169, 169 } },
    std::pair{ L"dark blue"sv, til::color{ 0, 0, 139 } },
    std::pair{ L"darkblue"sv, til::color{ 0, 0, 139 } },
    std::pair{ L"dark cyan"sv, til::color{ 0, 139, 139 } },
    std::pair{ L"darkcyan"sv, til::color{ 0, 139, 139 } },
    std::pair{ L"dark magenta"sv, til::color{ 139, 0, 139 } },
    std::pair{ L"darkmagenta"sv, til::color{ 139, 0, 139 } },
    std::pair{ L"dark red"sv, til::color{ 139, 0, 0 } },
    std::pair{ L"darkred"sv, til::color{ 139, 0, 0 } },
    std::pair{ L"light green"sv, til::color{ 144, 238, 144 } },
    ...
    std::pair{ L"rebecca purple"sv, til::color{ 102, 51, 153 } },
