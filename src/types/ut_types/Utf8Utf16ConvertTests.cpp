...
void Utf8Utf16ConvertTests::TestU8ToU16NonMinimals()
{
    ...
    std::wstring u16Out{};
    const HRESULT hRes{ U8ToU16(u8String, u16Out, true) }; // third parameter: invalid characters are discarded
...
void Utf8Utf16ConvertTests::TestU16ToU8Invalids()
{
    ...
    std::string u8Out{};
    const HRESULT hRes{ U16ToU8(u16String, u8Out, true) }; // third parameter: invalid characters are discarded
    VERIFY_ARE_EQUAL(S_FALSE, hRes);
    VERIFY_ARE_EQUAL(u8StringComp, u8Out);
}
