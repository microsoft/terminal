    ...
    switch (wMsg) {
                    ...
                    switch (HIWORD(wParam)) {
                        ...
                        case EN_CHANGE:
                            ...
                            if (bOK) {
                                ...
                                UpdateStateInfo(hDlg, ColorArray[iColor] + IDD_COLOR_1,
                                                RGB(Red, Green, Blue));
        ...
        case CM_SETCOLOR:
            ...
            UpdateItem(hDlg, IDD_COLOR_RED,
                       GetRValue(AttrToRGB(ColorArray[iColor])));
            UpdateItem(hDlg, IDD_COLOR_GREEN,
                       GetGValue(AttrToRGB(ColorArray[iColor])));
            UpdateItem(hDlg, IDD_COLOR_BLUE,
                       GetBValue(AttrToRGB(ColorArray[iColor])));
