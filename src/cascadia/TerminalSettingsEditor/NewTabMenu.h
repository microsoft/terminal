...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    ...
    public:
        ...
        void AddMatchProfiles_Click(Windows::Foundation::IInspectable const& sender, Windows::UI::Xaml::RoutedEventArgs const& args);
        void AddFolder_Click(Windows::Foundation::IInspectable const& sender, Windows::UI::Xaml::RoutedEventArgs const& args);
