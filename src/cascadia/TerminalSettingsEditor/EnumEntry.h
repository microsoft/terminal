...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    ...
    {
    public:
        EnumEntry(const winrt::hstring enumName, const winrt::Windows::Foundation::IInspectable& enumValue, const bool isActive);
        ...
        OBSERVABLE_GETSET_PROPERTY(bool, IsActive, _PropertyChangedHandlers);
    };
}
