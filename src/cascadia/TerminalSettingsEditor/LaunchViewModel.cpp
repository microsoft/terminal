...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    ...
    winrt::hstring LaunchViewModel::LaunchParametersCurrentValue()
    {
        ...
        {
            const std::wstring xPosString = isnan(InitialPosX()) ? RS_(L"Globals_LaunchModeDefault/Content").c_str() : std::to_wstring(til::narrow_cast<int>(InitialPosX()));
            const std::wstring yPosString = isnan(InitialPosY()) ? RS_(L"Globals_LaunchModeDefault/Content").c_str() : std::to_wstring(til::narrow_cast<int>(InitialPosY()));
    ...
    double LaunchViewModel::InitialPosX()
    {
        ...
        return xCoord.has_value() ? til::narrow_cast<double>(xCoord.value()) : NAN;
    }
    ...
    double LaunchViewModel::InitialPosY()
    {
        ...
        return yCoord.has_value() ? til::narrow_cast<double>(yCoord.value()) : NAN;
    }
    ...
    void LaunchViewModel::InitialPosX(double xCoord)
    {
        ...
        if (!isnan(xCoord))
        {
            xCoordRef = til::narrow_cast<int32_t>(xCoord);
        }
    ...
    void LaunchViewModel::InitialPosY(double yCoord)
    {
        ...
        if (!isnan(yCoord))
        {
            yCoordRef = til::narrow_cast<int32_t>(yCoord);
        }
