...
namespace SettingsModelUnitTests
{
    ...
    void TerminalSettingsTests::MakeSettingsForProfile()
    {
        ...
        try
        {
            auto settingsStruct{ TerminalSettings::CreateWithProfile(*settings, settings->WindowSettingsDefaults(), profile1) };
        ...
        try
        {
            auto settingsStruct{ TerminalSettings::CreateWithProfile(*settings, settings->WindowSettingsDefaults(), profile2) };
        ...
        try
        {
            const auto settingsStruct{ TerminalSettings::CreateWithNewTerminalArgs(*settings, settings->WindowSettingsDefaults(), nullptr) };
            VERIFY_ARE_EQUAL(1, settingsStruct.DefaultSettings()->HistorySize());
        }
        catch (...)
        {
    ...
    void TerminalSettingsTests::TestCommandlineToTitlePromotion()
    {
        ...
        { // just a profile (profile wins)
            ...
            const auto settingsStruct{ TerminalSettings::CreateWithNewTerminalArgs(*settings, settings->WindowSettingsDefaults(), args) };
