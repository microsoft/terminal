...
namespace winrt::TerminalApp::implementation
{
    ...
    private:
        ...
        void _ScrollHome(ScrollDirection scrollDirection);
...
#pragma region ActionHandlers
        ...
        void _HandleScrollHome(const IInspectable& sender, const Microsoft::Terminal::Settings::Model::ActionEventArgs& args);
        void _HandleScrollEnd(const IInspectable& sender, const Microsoft::Terminal::Settings::Model::ActionEventArgs& args);
