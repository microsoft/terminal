...
static constexpr std::wstring_view SPLITVERTICAL_KEY{ L"splitVertical" };
static constexpr std::wstring_view SPLITHORIZONTAL_KEY{ L"splitHorizontal" };
...
static const std::map<std::wstring_view, ShortcutAction> commandNames {
    ...
    { SPLITVERTICAL_KEY, ShortcutAction::SplitVertical },
    { SPLITHORIZONTAL_KEY, ShortcutAction::SplitHorizontal },
