...
namespace winrt::TerminalApp::implementation
{
    ...
    // hstring MarkdownPaneContent::Title()
    // {
    ...
    // void MarkdownPaneContent::_createNotebook()
    // {
    ...
    // void MarkdownPaneContent::_newBlockHandler(const Control::Notebook& /*sender*/,
    ...
    // void MarkdownPaneContent::_scrollToElement(const WUX::UIElement& element,
    ...
    // void MarkdownPaneContent::_addControl(const Control::TermControl& control)
    // {
    //     control.Height(256);
    ...
    // winrt::fire_and_forget MarkdownPaneContent::_stupid(WUX::UIElement elem)
    // {
