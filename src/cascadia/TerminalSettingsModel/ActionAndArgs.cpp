...
static constexpr std::string_view FindNextKey{ "findNext" };
static constexpr std::string_view FindPrevKey{ "findPrev" };
...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    const std::map<std::string_view, ShortcutAction, std::less<>> ActionAndArgs::ActionKeyNamesMap{
        ...
        { FindNextKey, ShortcutAction::FindNext },
        { FindPrevKey, ShortcutAction::FindPrev },
    };
    ...
    winrt::hstring ActionAndArgs::GenerateName() const
    {
        ...
        static const auto GeneratedActionNames = []() {
            return std::unordered_map<ShortcutAction, winrt::hstring>{
                ...
                { ShortcutAction::FindNext, RS_(L"FindNextCommandKey") },
                { ShortcutAction::FindPrev, RS_(L"FindPrevCommandKey") },
            };
        }();
