...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    public:
        ...
        INHERITABLE_SETTING(Model::IAppearanceConfig, Microsoft::Terminal::Settings::Model::IntenseStyle, IntenseTextStyle, Microsoft::Terminal::Settings::Model::IntenseStyle::All);
