...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    public:
        ...
        OBSERVABLE_GETSET_PROPERTY(winrt::Microsoft::Terminal::Settings::Model::BellStyle, BellStyle, _PropertyChangedHandlers, winrt::Microsoft::Terminal::Settings::Model::BellStyle::Audible);
