...
namespace TerminalAppLocalTests
{
    ...
    class TabTests
    {
        ...
        TEST_METHOD(TabRowAcrylicKeepsBackdropAcrylicWhenTerminalUsesInAppAcrylic);
    ...
    void TabTests::TabRowAcrylicKeepsBackdropAcrylicWhenTerminalUsesInAppAcrylic()
    {
        BEGIN_TEST_METHOD_PROPERTIES()
            TEST_METHOD_PROPERTY(L"IsolationLevel", L"Method")
        END_TEST_METHOD_PROPERTIES()
        ...
        TestOnUIThread([&page]() {
            ...
            VERIFY_IS_NOT_NULL(titlebarAcrylicBrush);
            VERIFY_ARE_EQUAL(winrt::Windows::UI::Xaml::Media::AcrylicBackgroundSource::Backdrop, titlebarAcrylicBrush.BackgroundSource());
        });
