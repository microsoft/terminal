...
namespace TerminalAppLocalTests
{
    ...
    void TabTests::TryDuplicateBadPane()
    {
        ...
        result = RunOnUIThread([&page]() {
            page->_SplitPane(page->_MakePane(nullptr, true, nullptr), SplitDirection::Automatic, 0.5f);
    ...
    void TabTests::SwapPanes()
    {
        ...
        TestOnUIThread([&]() {
            ...
            // |        |        |
            // -------------------
            page->_SplitPane(page->_MakePane(nullptr, true, nullptr), SplitDirection::Right, 0.5f);
        ...
        TestOnUIThread([&]() {
            ...
            // |        |        |
            // -------------------
            page->_SplitPane(page->_MakePane(nullptr, true, nullptr), SplitDirection::Down, 0.5f);
            auto tab = page->_GetTerminalTabImpl(page->_tabs.GetAt(0));
            // Split again to make the 3rd tab
