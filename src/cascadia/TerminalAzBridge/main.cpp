...
int wmain(int /*argc*/, wchar_t** /*argv*/)
{
    ...
    vs.Insert(L"initialRows", winrt::Windows::Foundation::PropertyValue::CreateUInt32(til::narrow_cast<uint32_t>(size.height)));
    vs.Insert(L"initialCols", winrt::Windows::Foundation::PropertyValue::CreateUInt32(til::narrow_cast<uint32_t>(size.width)));
