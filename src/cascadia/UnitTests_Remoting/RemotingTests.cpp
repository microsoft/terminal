...
namespace RemotingUnitTests
{
    ...
    struct DeadPeasant : implements<DeadPeasant, winrt::Microsoft::Terminal::Remoting::IPeasant>
    {
        ...
        void RequestShowTrayIcon() { throw winrt::hresult_error(winrt::hresult{ (int32_t)0x800706ba }); };
        void RequestHideTrayIcon() { throw winrt::hresult_error(winrt::hresult{ (int32_t)0x800706ba }); };
