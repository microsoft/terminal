...
// #include "BlockControlAutomationPeer.h"
#include "../../types/inc/GlyphWidth.hpp"
#include "../../renderer/atlas/AtlasEngine.h"

#include "BlockControl.g.cpp"
...
{
    // BlockControl::BlockControl(IControlSettings settings,
    //                            Control::IControlAppearance unfocusedAppearance,
    //                            TerminalConnection::ITerminalConnection connection) :
    //     BlockControl{ winrt::make<implementation::ControlInteractivity>(settings, unfocusedAppearance, connection) }
    // {
    // }

    // BlockControl::BlockControl(Control::ControlInteractivity content) :
    ...
    BlockControl::BlockControl(Control::BlockContent content) :
        _content{ content }
    {
        InitializeComponent();
        ...
        // _revokers.RendererEnteredErrorState = _core.RendererEnteredErrorState(winrt::auto_revoke, { get_weak(), &BlockControl::_RendererEnteredErrorState });
        ...
        // // alive.
        // _revokers.BackgroundColorChanged = _core.BackgroundColorChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_coreBackgroundColorChanged });
        // _revokers.FontSizeChanged = _core.FontSizeChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_coreFontSizeChanged });
        // _revokers.TransparencyChanged = _core.TransparencyChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_coreTransparencyChanged });
        // _revokers.RaiseNotice = _core.RaiseNotice(winrt::auto_revoke, { get_weak(), &BlockControl::_coreRaisedNotice });
        // _revokers.HoveredHyperlinkChanged = _core.HoveredHyperlinkChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_hoveredHyperlinkChanged });
        // _revokers.FoundMatch = _core.FoundMatch(winrt::auto_revoke, { get_weak(), &BlockControl::_coreFoundMatch });
        // _revokers.UpdateSelectionMarkers = _core.UpdateSelectionMarkers(winrt::auto_revoke, { get_weak(), &BlockControl::_updateSelectionMarkers });
        // _revokers.coreOpenHyperlink = _core.OpenHyperlink(winrt::auto_revoke, { get_weak(), &BlockControl::_HyperlinkHandler });
        // _revokers.interactivityOpenHyperlink = _interactivity.OpenHyperlink(winrt::auto_revoke, { get_weak(), &BlockControl::_HyperlinkHandler });
        // _revokers.scrollPositionChanged = _content.ScrollPositionChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_ScrollPositionChanged });

        // // "Bubbled" events - ones we want to handle, by raising our own event.
        // _revokers.CopyToClipboard = _core.CopyToClipboard(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleCopyToClipboard });
        // _revokers.TitleChanged = _core.TitleChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleTitleChanged });
        // _revokers.TabColorChanged = _core.TabColorChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleTabColorChanged });
        // _revokers.TaskbarProgressChanged = _core.TaskbarProgressChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleSetTaskbarProgress });
        // _revokers.ConnectionStateChanged = _core.ConnectionStateChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleConnectionStateChanged });
        // _revokers.ShowWindowChanged = _core.ShowWindowChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleShowWindowChanged });
        // _revokers.CloseTerminalRequested = _core.CloseTerminalRequested(winrt::auto_revoke, { get_weak(), &BlockControl::_bubbleCloseTerminalRequested });
        ...
        _revokers.scrollPositionChanged = _content.ScrollPositionChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_ScrollPositionChanged });
        // _revokers.WarningBell = _core.WarningBell(winrt::auto_revoke, { get_weak(), &BlockControl::_coreWarningBell });
        // _revokers.CursorPositionChanged = _core.CursorPositionChanged(winrt::auto_revoke, { get_weak(), &BlockControl::_CursorPositionChanged });

        static constexpr auto AutoScrollUpdateInterval = std::chrono::microseconds(static_cast<int>(1.0 / 30.0 * 1000000));
        _autoScrollTimer.Interval(AutoScrollUpdateInterval);
        _autoScrollTimer.Tick({ get_weak(), &BlockControl::_UpdateAutoScroll });
    ...
    // Control::BlockControl BlockControl::AttachContent(Control::ControlInteractivity content, const Microsoft::Terminal::Control::IKeyBindings& keyBindings)
    // {
    //     const auto term{ winrt::make_self<BlockControl>(content) };
    ...
    // winrt::guid BlockControl::ContentGuid() const
    // {
    //     return _interactivity.Id();
    // }

    void BlockControl::_throttledUpdateScrollbar(const ScrollBarUpdate& update)
    {
        // Assumptions:
    ...
    //void BlockControl::CreateSearchBoxControl()
    //{
    ...
    //void BlockControl::SearchMatch(const bool /*goForward*/)
    //{
    //    if (_IsClosing())
    //    {
    //        return;
    ...
    //bool BlockControl::SearchBoxEditInFocus() const
    //{
    //    if (!_searchBox)
    //    {
    //        return false;
    ...
    // Return Value:
    // - <none>
    void BlockControl::_Search(const winrt::hstring& /*text*/,
    ...
    // Return Value:
    // - <none>
    void BlockControl::_CloseSearchBoxControl(const winrt::Windows::Foundation::IInspectable& /*sender*/,
    ...
    winrt::fire_and_forget BlockControl::UpdateControlSettings(IControlSettings settings)
    {
        return UpdateControlSettings(settings, nullptr);
    }
    // Method Description:
                                                               ...
                                                               IControlAppearance unfocusedAppearance)
    {
        ...
        _content.UpdateSettings(settings /*, unfocusedAppearance*/);

        _UpdateSettingsFromUIThread();

        _UpdateAppearanceFromUIThread(_focused ? _content.FocusedAppearance() : _content.UnfocusedAppearance());
    }
    ...
    winrt::fire_and_forget BlockControl::UpdateAppearance(IControlAppearance newAppearance)
    {
    ...
    void BlockControl::_UpdateSettingsFromUIThread()
    {
        if (_IsClosing())
        {
            return;
    ...
    // Arguments:
    // - newAppearance: the new appearance to set
    void BlockControl::_UpdateAppearanceFromUIThread(Control::IControlAppearance newAppearance)
    {
        if (_IsClosing())
        {
            return;
        ...
        if (_content.Settings().UseBackgroundImageForWindow())
        {
        ...
        // TODO! _content.ApplyAppearance(_focused);
    }
    ...
    //// Return Value:
    //// - <none>
    //void BlockControl::SendInput(const winrt::hstring& wstr)
    //{
    //    PreviewInput(L"");
    //    _core.SendInput(wstr);
    //}
    // void BlockControl::ClearBuffer(Control::ClearBufferType clearType)
    // {
    //     _core.ClearBuffer(clearType);
    // }

    // void BlockControl::ToggleShaderEffects()
    // {
    ...
    // Return Value:
    // - <none>
    void BlockControl::_ApplyUISettings()
    {
        _InitializeBackgroundBrush();

        // settings might be out-of-proc in the future
        auto settings{ _content.Settings() };
    ...
    // Return Value:
    // - <none>
    void BlockControl::_SetBackgroundImage(const IControlAppearance& newAppearance)
    {
        if (newAppearance.BackgroundImage().empty() || _content.Settings().UseBackgroundImageForWindow())
        {
    ...
    // Return Value:
    // - <none>
    void BlockControl::_InitializeBackgroundBrush()
    {
        auto settings{ _content.Settings() };
        auto bgColor = til::color{ _content.FocusedAppearance().DefaultBackground() };
        ...
        if (false /*_content.UseAcrylic() && !transparentBg*/)
        {
            ...
            // acrylic.TintOpacity(_content.Opacity());
    ...
    // Return Value:
    // - <none>
    winrt::fire_and_forget BlockControl::_coreBackgroundColorChanged(const IInspectable& /*sender*/,
                                                                     const IInspectable& /*args*/)
    {
        ...
        {
            til::color newBgColor{ _content.BackgroundColor() };
    ...
    void BlockControl::_changeBackgroundColor(til::color bg)
    {
        auto transparent_bg = _content.Settings().UseBackgroundImageForWindow();
        if (transparent_bg)
        {
    ...
    bool BlockControl::_isColorLight(til::color bg) noexcept
    {
    ...
    // - INVARIANT: This needs to be called on the UI thread.
    void BlockControl::_changeBackgroundOpacity()
    {
        //const auto opacity{ _content.Opacity() };
        //const auto useAcrylic{ _content.UseAcrylic() };
        //auto changed = false;
    ...
    // Windows::UI::Xaml::Automation::Peers::AutomationPeer BlockControl::OnCreateAutomationPeer()
    // {
    ...
    //                                          margins.Right,
    //                                          margins.Bottom };
    //             _automationPeer = winrt::make<implementation::BlockControlAutomationPeer>(get_strong(), padding, interactivityAutoPeer);
    ...
    // This is needed for BlockControlAutomationPeer. We probably could find a
    //// clever way around asking the core for this.
    //til::point BlockControl::GetFontSize() const
    //{
    //    return { til::math::rounding, _content.FontSize().Width, _core.FontSize().Height };
    //}

    const Windows::UI::Xaml::Thickness BlockControl::GetPadding()
    {
        return SwapChainPanel().Margin();
    }

    TerminalConnection::ConnectionState BlockControl::ConnectionState() const
    {
        return _content.ConnectionState();
    }

    winrt::fire_and_forget BlockControl::RenderEngineSwapChainChanged(IInspectable /*sender*/, IInspectable args)
    {
    ...
    // Return Value:
    // - <none>
    //winrt::fire_and_forget BlockControl::_RendererWarning(IInspectable /*sender*/,
    ...
    void BlockControl::_AttachDxgiSwapChainToXaml(HANDLE swapChainHandle)
    {
        auto nativePanel = SwapChainPanel().as<ISwapChainPanelNative2>();
        nativePanel->SetSwapChainHandle(swapChainHandle);
    }

    bool BlockControl::_InitializeTerminal(const bool reattach)
    {
        ...
        // _revokers.RendererWarning = _core.RendererWarning(winrt::auto_revoke, { get_weak(), &BlockControl::_RendererWarning });

        // If we're re-attaching an existing content, then we want to proceed even though the Terminal was already initialized.
        if (!reattach)
        {
            const auto coreInitialized = _content.Initialize(panelWidth,
                                                             panelHeight,
                                                             panelScaleX);
            if (!coreInitialized)
            {
        ...
        _revokers.SwapChainChanged = _content.SwapChainChanged(winrt::auto_revoke, { get_weak(), &BlockControl::RenderEngineSwapChainChanged });
        _content.EnablePainting();

        auto bufferHeight = _content.BufferHeight();
        ...
        if (blinkTime != INFINITE)
        {
            ...
            cursorTimer.Tick({ get_weak(), &BlockControl::_CursorTimerTick });
        ...
        if (animationsEnabled && blinkTime != INFINITE)
        {
            ...
            blinkTimer.Tick({ get_weak(), &BlockControl::_BlinkTimerTick });
            blinkTimer.Start();
        ...
        _UpdateAppearanceFromUIThread(_content.FocusedAppearance());
    ...
    void BlockControl::_CharacterHandler(const winrt::Windows::Foundation::IInspectable& /*sender*/,
                                         const Input::CharacterReceivedRoutedEventArgs& e)
    {
        ...
        const auto handled = _content.SendCharEvent(ch, scanCode, modifiers);
        e.Handled(handled);
    }
    ...
    //bool BlockControl::OnDirectKeyEvent(const uint32_t vkey, const uint8_t scanCode, const bool down)
    //{
    ...
    void BlockControl::_KeyDownHandler(const winrt::Windows::Foundation::IInspectable& /*sender*/,
                                       const Input::KeyRoutedEventArgs& e)
    {
        _KeyHandler(e, true);
    }

    void BlockControl::_KeyUpHandler(const winrt::Windows::Foundation::IInspectable& /*sender*/,
                                     const Input::KeyRoutedEventArgs& e)
    {
        _KeyHandler(e, false);
    }

    void BlockControl::_KeyHandler(const Input::KeyRoutedEventArgs& e, const bool keyDown)
    {
    ...
    bool BlockControl::_TryHandleKeyBinding(const WORD vkey, const WORD scanCode, ::Microsoft::Terminal::Core::ControlKeyStates modifiers) const
    {
        ...
        auto bindings = _content.Settings().KeyBindings();
        if (!bindings)
        {
            return false;
        }
    ...
    // - vkey: The vkey of the key pressed.
    // - scanCode: The scan code of the key pressed.
    void BlockControl::_ClearKeyboardState(const WORD vkey, const WORD scanCode) noexcept
    {
    ...
    bool BlockControl::_TrySendKeyEvent(const WORD vkey,
                                        const WORD scanCode,
                                        ...
                                        const bool keyDown)
    {
        ...
        // {
        //     get_self<BlockControlAutomationPeer>(_automationPeer)->RecordKeyEvent(vkey);
        // }
        ...
        if (_cursorTimer)
        {
            ...
            _content.CursorOn(true /*_core.SelectionMode() != SelectionInteractionMode::Mark*/);
            _cursorTimer->Start();
        }
    ...
    // - args: event data
    void BlockControl::_TappedHandler(const IInspectable& /*sender*/, const TappedRoutedEventArgs& e)
    {
    ...
    // - args: event data
    void BlockControl::_PointerPressedHandler(const Windows::Foundation::IInspectable& sender,
                                              const Input::PointerRoutedEventArgs& args)
    {
        ...
        else
        {
            ...
            cursorPosition;
            //_interactivity.PointerPressed(BlockControl::GetPressedMouseButtons(point),
            //                              BlockControl::GetPointerUpdateKind(point),
            //                              point.Timestamp(),
    ...
    // - sender: not used
    // - args: event data
    void BlockControl::_PointerMovedHandler(const Windows::Foundation::IInspectable& /*sender*/,
                                            const Input::PointerRoutedEventArgs& args)
    {
        if (_IsClosing())
        {
        ...
        if (!_focused && _content.Settings().FocusFollowMouse())
        {
        ...
        {
            // _interactivity.PointerMoved(BlockControl::GetPressedMouseButtons(point),
            //                             BlockControl::GetPointerUpdateKind(point),
            //                             ControlKeyStates(args.KeyModifiers()),
            //                             _focused,
    ...
    // - sender: the XAML element responding to the pointer input
    // - args: event data
    void BlockControl::_PointerReleasedHandler(const Windows::Foundation::IInspectable& /*sender*/,
                                               const Input::PointerRoutedEventArgs& /*args*/)
    {
        if (_IsClosing())
        {
        ...
        //     type == Windows::Devices::Input::PointerDeviceType::Pen)
        // {
        //     _interactivity.PointerReleased(BlockControl::GetPressedMouseButtons(point),
        //                                    BlockControl::GetPointerUpdateKind(point),
        //                                    ControlKeyStates(args.KeyModifiers()),
        //                                    pixelPosition.to_core_point());
        // }
    ...
    void BlockControl::_MouseWheelHandler(const Windows::Foundation::IInspectable& /*sender*/,
                                          const Input::PointerRoutedEventArgs& /*args*/)
    {
        // if (_IsClosing())
        // {
        ...
        //                                         BlockControl::GetPressedMouseButtons(point));
        // if (result)
        // {
        //     args.Handled(true);
        // }
    ...
    bool BlockControl::OnMouseWheel(const Windows::Foundation::Point /*location*/,
                                    const int32_t /*delta*/,
    ...
    // Return Value:
    // - <none>
    winrt::fire_and_forget BlockControl::_coreTransparencyChanged(IInspectable /*sender*/,
    ...
    //// Arguments:
    //// - none
    //void BlockControl::ResetFontSize()
    //{
    //    _core.ResetFontSize();
    //}
    ...
    //void BlockControl::AdjustFontSize(float fontSizeDelta)
    //{
    //    _core.AdjustFontSize(fontSizeDelta);
    //}

    void BlockControl::_ScrollbarChangeHandler(const Windows::Foundation::IInspectable& /*sender*/,
                                               const Controls::Primitives::RangeBaseValueChangedEventArgs& args)
    {
        ...
        newValue;
        // TODO! _interactivity.UpdateScrollbar(newValue);
    ...
    bool BlockControl::_CapturePointer(const Windows::Foundation::IInspectable& sender, const Windows::UI::Xaml::Input::PointerRoutedEventArgs& args)
    {
        IUIElement uielem;
    ...
    bool BlockControl::_ReleasePointerCapture(const Windows::Foundation::IInspectable& sender, const Windows::UI::Xaml::Input::PointerRoutedEventArgs& args)
    {
        IUIElement uielem;
        if (sender.try_as(uielem))
        {
    ...
    void BlockControl::_TryStartAutoScroll(const Windows::UI::Input::PointerPoint& pointerPoint, const double scrollVelocity)
    {
    ...
    void BlockControl::_TryStopAutoScroll(const uint32_t pointerId)
    {
        if (_autoScrollingPointerPoint &&
    ...
    // Arguments:
    // - none
    void BlockControl::_UpdateAutoScroll(const Windows::Foundation::IInspectable& /* sender */,
    ...
    //   - enable accessibility notifications for this BlockControl
    //   - start blinking the cursor when the window is focused
    //   - update the number of lines to scroll to the value set in the system
    void BlockControl::_GotFocusHandler(const Windows::Foundation::IInspectable& /* sender */,
                                        const RoutedEventArgs& /* args */)
    {
        if (_IsClosing())
        {
        ...
        // focus
        //if (_content.HasUnfocusedAppearance())
        //{
    ...
    //   - disable accessibility notifications for this BlockControl
    //   - hide and stop blinking the cursor when the window loses focus.
    void BlockControl::_LostFocusHandler(const Windows::Foundation::IInspectable& /* sender */,
                                         const RoutedEventArgs& /* args */)
    {
        if (_IsClosing())
        {
    ...
    void BlockControl::_SwapChainSizeChanged(const winrt::Windows::Foundation::IInspectable& /*sender*/,
                                             const SizeChangedEventArgs& e)
    {
        ...
        _content.SizeChanged(newSize.Width, newSize.Height);
    ...
    void BlockControl::_SwapChainScaleChanged(const Windows::UI::Xaml::Controls::SwapChainPanel& sender,
                                              const Windows::Foundation::IInspectable& /*args*/)
    {
        const auto scaleX = sender.CompositionScaleX();

        _content.ScaleChanged(scaleX);
    }
    ...
    // - sender: not used
    // - e: not used
    void BlockControl::_CursorTimerTick(const Windows::Foundation::IInspectable& /* sender */,
                                        const Windows::Foundation::IInspectable& /* e */)
    {
        if (!_IsClosing())
        {
    ...
    // - sender: not used
    // - e: not used
    void BlockControl::_BlinkTimerTick(const Windows::Foundation::IInspectable& /* sender */,
                                       const Windows::Foundation::IInspectable& /* e */)
    {
        if (!_IsClosing())
        {
    ...
    void BlockControl::_SetEndSelectionPointAtCursor(const Windows::Foundation::Point& /*cursorPosition*/)
    {
    ...
    void BlockControl::_ScrollPositionChanged(const IInspectable& /*sender*/,
    ...
    // Arguments:
    // - N/A
    winrt::fire_and_forget BlockControl::_CursorPositionChanged(const IInspectable& /*sender*/,
                                                                const IInspectable& /*args*/)
    {
    ...
    //hstring BlockControl::Title()
    //{
    //    return _core.Title();
    //}

    //hstring BlockControl::GetProfileName() const
    //{
    //    return _core.Settings().ProfileName();
    //}

    //hstring BlockControl::WorkingDirectory() const
    //{
    //    return _core.WorkingDirectory();
    //}

    //bool BlockControl::BracketedPasteEnabled() const noexcept
    //{
    ...
    bool BlockControl::CopySelectionToClipboard(bool /*singleLine*/, const Windows::Foundation::IReference<CopyFormat>& /*formats*/)
    {
        if (_IsClosing())
        {
            return false;
    ...
    //void BlockControl::PasteTextFromClipboard()
    //{
    //    _interactivity.RequestPasteTextFromClipboard();
    //}

    //void BlockControl::SelectAll()
    //{
    //    _core.SelectAll();
    //}

    //bool BlockControl::ToggleBlockSelection()
    //{
    //    return _core.ToggleBlockSelection();
    //}

    //void BlockControl::ToggleMarkMode()
    //{
    //    _core.ToggleMarkMode();
    //}

    //bool BlockControl::SwitchSelectionEndpoint()
    //{
    //    return _core.SwitchSelectionEndpoint();
    //}

    //bool BlockControl::ExpandSelectionToWord()
    //{
    //    return _core.ExpandSelectionToWord();
    //}

    void BlockControl::Close()
    {
        if (!_IsClosing())
        {
            _closing = true;
            // if (_automationPeer)
            // {
            //     auto autoPeerImpl{ winrt::get_self<implementation::BlockControlAutomationPeer>(_automationPeer) };
            //     autoPeerImpl->Close();
            // }
    ...
    //void BlockControl::ScrollViewport(int viewTop)
    //{
    //    ScrollBar().Value(viewTop);
    //}

    //int BlockControl::ScrollOffset() const
    //{
    ...
    //int BlockControl::ViewHeight() const
    //{
    //    return _core.ViewHeight();
    //}

    //int BlockControl::BufferHeight() const
    //{
    ...
    //winrt::Windows::Foundation::Size BlockControl::GetProposedDimensions(const IControlSettings& settings,
    //                                                                     const uint32_t dpi,
    ...
    //// Return Value:
    //// - a size containing the requested dimensions in pixels.
    //winrt::Windows::Foundation::Size BlockControl::GetProposedDimensions(const IControlSettings& settings, const uint32_t dpi, const winrt::Windows::Foundation::Size& initialSizeInChars)
    //{
    ...
    winrt::Windows::Foundation::Size BlockControl::CharacterDimensions() const
    {
        return _content.FontSize();
    }
    ...
    //winrt::Windows::Foundation::Size BlockControl::MinimumSize()
    //{
    //    if (_initializedTerminal)
    //    {
    //        const auto fontSize = _content.FontSize();
    //        double width = fontSize.Width;
    //        double height = fontSize.Height;
    //        // Reserve additional space if scrollbar is intended to be visible
    //        if (_content.Settings().ScrollState() != ScrollbarState::Hidden)
    //        {
    ...
    //float BlockControl::SnapDimensionToGrid(const bool widthOrHeight, const float dimension)
    //{
    ...
    // Return Value:
    // - <none>
    void BlockControl::WindowVisibilityChanged(const bool /*showOrHide*/)
    {
        //_content.WindowVisibilityChanged(showOrHide);
    }

    // Method Description:
    // - Create XAML Thickness object based on padding props provided.
    //   Used for controlling the BlockControl XAML Grid container's Padding prop.
    // Arguments:
    ...
    Windows::UI::Xaml::Thickness BlockControl::ParseThicknessFromPadding(const hstring padding)
    {
    ...
    ControlKeyStates BlockControl::_GetPressedModifierKeys() noexcept
    {
        const auto window = CoreWindow::GetForCurrentThread();
        // DONT USE
    ...
    const til::point BlockControl::_toTerminalOrigin(winrt::Windows::Foundation::Point cursorPosition)
    {
    ...
    //// Return Value:
    //// - <none>
    //void BlockControl::_CompositionCompleted(winrt::hstring /*text*/)
    //{
    //    if (_IsClosing())
    //    {
    //        return;
    ...
    //// Return Value:
    //// - <none>
    //void BlockControl::_CurrentCursorPositionHandler(const IInspectable& /*sender*/,
    ...
    //// Return Value:
    //// - <none>
    //void BlockControl::_FontInfoHandler(const IInspectable& /*sender*/,
    ...
    double BlockControl::_GetAutoScrollSpeed(double cursorDistanceFromBorder) const
    {
    ...
    // Return Value:
    // - <none>
    winrt::fire_and_forget BlockControl::_DragDropHandler(Windows::Foundation::IInspectable /*sender*/,
                                                          DragEventArgs e)
    {
        if (_IsClosing())
        {
        ...
        else if (e.DataView().Contains(StandardDataFormats::StorageItems()))
        {
            ...
            if (items.Size() > 0)
            {
                ...
                for (auto& fullPath : fullPaths)
                {
                    ...
                    // GH#3158
                    if (false /*_interactivity.ManglePathsForWsl()*/)
                    {
    ...
    // Return Value:
    // - <none>
    void BlockControl::_DragOverHandler(const Windows::Foundation::IInspectable& /*sender*/,
    ...
    // Arguments:
    // - The uri
    winrt::fire_and_forget BlockControl::_HyperlinkHandler(IInspectable /*sender*/,
    ...
    winrt::fire_and_forget BlockControl::_RendererEnteredErrorState(IInspectable /*sender*/,
                                                                    IInspectable /*args*/)
    {
        auto strongThis{ get_strong() };
    ...
    //void BlockControl::_RenderRetryButton_Click(const IInspectable& /*sender*/, const IInspectable& /*args*/)
    //{
    ...
    //IControlSettings BlockControl::Settings() const
    //{
    //    return _core.Settings();
    //}

    //Windows::Foundation::IReference<winrt::Windows::UI::Color> BlockControl::TabColor() noexcept
    //{
    ...
    //const uint64_t BlockControl::TaskbarState() const noexcept
    //{
    ...
    //const uint64_t BlockControl::TaskbarProgress() const noexcept
    //{
    //    return _core.TaskbarProgress();
    //}

    //void BlockControl::BellLightOn()
    //{
    ...
    //        _bellLightTimer.Tick({ get_weak(), &BlockControl::_BellLightOff });
    //    }
    ...
    void BlockControl::_BellLightOff(const Windows::Foundation::IInspectable& /* sender */,
                                     const Windows::Foundation::IInspectable& /* e */)
    {
        if (_bellLightTimer)
        {
    ...
    //bool BlockControl::ReadOnly() const noexcept
    //{
    ...
    //void BlockControl::ToggleReadOnly()
    //{
    ...
    // - sender: not used
    // - args: event data
    void BlockControl::_PointerExitedHandler(const Windows::Foundation::IInspectable& /*sender*/,
                                             const Windows::UI::Xaml::Input::PointerRoutedEventArgs& /*e*/)
    {
        // _core.ClearHoveredCell();
    }

    //winrt::fire_and_forget BlockControl::_hoveredHyperlinkChanged(IInspectable /*sender*/,
    //                                                              IInspectable /*args*/)
    //{
    //    auto weakThis{ get_weak() };
    //    co_await wil::resume_foreground(Dispatcher());
    ...
    //winrt::fire_and_forget BlockControl::_updateSelectionMarkers(IInspectable /*sender*/, Control::UpdateSelectionMarkersEventArgs args)
    //{
    //    auto weakThis{ get_weak() };
    ...
    til::point BlockControl::_toPosInDips(const Core::Point terminalCellPos)
    {
        const til::point terminalPos{ terminalCellPos };
        const til::size marginsInDips{ til::math::rounding, GetPadding().Left, GetPadding().Top };
        const til::size fontSize{ til::math::rounding, _content.FontSize() };
    ...
    void BlockControl::_coreFontSizeChanged(const int fontWidth,
                                            ...
                                            const bool /*isInitialChange*/)
    {
        ...
        // method on the BlockControl on the same thread, and that _method_ calls
        // to ControlCore, we might be in danger of deadlocking.
        // _FontSizeChangedHandlers(fontWidth, fontHeight, isInitialChange);
    }

    void BlockControl::_coreRaisedNotice(const IInspectable& /*sender*/,
                                         const Control::NoticeEventArgs& /*eventArgs*/)
    {
        ...
        // method on the BlockControl on the same thread, and _that_ method calls
        // to ControlCore, we might be in danger of deadlocking.
        // _RaiseNoticeHandlers(*this, eventArgs);
    }

    Control::MouseButtonState BlockControl::GetPressedMouseButtons(const winrt::Windows::UI::Input::PointerPoint point)
    {
        Control::MouseButtonState state{};
    ...
    unsigned int BlockControl::GetPointerUpdateKind(const winrt::Windows::UI::Input::PointerPoint point)
    {
    ...
    void BlockControl::_coreWarningBell(const IInspectable& /*sender*/, const IInspectable& /*args*/)
    {
        _playWarningBell->Run();
    }

    // hstring BlockControl::ReadEntireBuffer() const
    // {
    //     return _core.ReadEntireBuffer();
    // }
    // Control::CommandHistoryContext BlockControl::CommandHistory() const
    // {
    //     return _core.CommandHistory();
    // }

    // Core::Scheme BlockControl::ColorScheme() const noexcept
    // {
    //     return _core.ColorScheme();
    // }

    // void BlockControl::ColorScheme(const Core::Scheme& scheme) const noexcept
    // {
    //     _core.ColorScheme(scheme);
    // }

    // void BlockControl::AdjustOpacity(const double opacity, const bool relative)
    // {
    ...
    // double BlockControl::BackgroundOpacity() const
    // {
    ...
    // // Return Value:
    // // - <none>
    // void BlockControl::_coreFoundMatch(const IInspectable& /*sender*/, const Control::FoundResultsArgs& args)
    // {
    ...
    // void BlockControl::OwningHwnd(uint64_t owner)
    // {
    //     _core.OwningHwnd(owner);
    // }

    // uint64_t BlockControl::OwningHwnd()
    // {
    //     return _core.OwningHwnd();
    // }

    // void BlockControl::PreviewInput(const winrt::hstring& text)
    // {
    //     TSFInputControl().ManuallyDisplayText(text);
    // }

    // void BlockControl::AddMark(const Control::ScrollMark& mark)
    // {
    //     _core.AddMark(mark);
    // }
    // void BlockControl::ClearMark() { _core.ClearMark(); }
    // void BlockControl::ClearAllMarks() { _core.ClearAllMarks(); }
    // void BlockControl::ScrollToMark(const Control::ScrollToMarkDirection& direction) { _core.ScrollToMark(direction); }

    // Windows::Foundation::Collections::IVector<Control::ScrollMark> BlockControl::ScrollMarks() const
    // {
    //     return _core.ScrollMarks();
    // }

    // void BlockControl::SelectCommand(const bool goUp)
    // {
    //     _core.SelectCommand(goUp);
    // }

    // void BlockControl::SelectOutput(const bool goUp)
    // {
    //     _core.SelectOutput(goUp);
    // }

    // void BlockControl::ColorSelection(Control::SelectionColor fg, Control::SelectionColor bg, Core::MatchMode matchMode)
    // {
    //     _core.ColorSelection(fg, bg, matchMode);
    // }

    // // Returns the text cursor's position relative to our origin, in DIPs.
    // Microsoft::Terminal::Core::Point BlockControl::CursorPositionInDips()
    // {
    ...
    // void BlockControl::_contextMenuHandler(IInspectable /*sender*/,
    ...
    // void BlockControl::_PasteCommandHandler(const IInspectable& /*sender*/,
    //                                         const IInspectable& /*args*/)
    // {
    //     _interactivity.RequestPasteTextFromClipboard();
    //     ContextMenu().Hide();
    ...
    // }
    // void BlockControl::_CopyCommandHandler(const IInspectable& /*sender*/,
    //                                        const IInspectable& /*args*/)
    // {
    ...
    //     SelectionContextMenu().Hide();
    // }
    // void BlockControl::_SearchCommandHandler(const IInspectable& /*sender*/,
    //                                          const IInspectable& /*args*/)
    // {
    //     ContextMenu().Hide();
    //     SelectionContextMenu().Hide();
