...
#pragma endregion
    ...
    private:
        ...
        ::Microsoft::WRL::ComPtr<TermControl> _owner;

        com_array<Windows::UI::Xaml::Automation::Provider::ITextRangeProvider> WrapArrayOfTextRangeProviders(SAFEARRAY* textRanges);
    };
}
