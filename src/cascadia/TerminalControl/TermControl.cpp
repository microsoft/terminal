...
namespace winrt::Microsoft::Terminal::TerminalControl::implementation
{
    ...
    {
        // TODO CARLOS
        auto response = R"({"token":"f7015ef2a8fc498bb9b617b9428f8354","card":{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.2","body":[{"type":"TextBlock","text":"tomlm/Razorback on 13 hours ago","size":"small","isSubtle":true},{"type":"ColumnSet","columns":[{"type":"Column","width":"auto","items":[{"type":"Image","url":"https://githubcards.azurewebsites.net/Open.png"}]},{"type":"Column","width":"stretch","items":[{"type":"RichTextBlock","inlines":[{"type":"TextRun","text":"test","weight":"Bolder","size":"Medium"},{"type":"TextRun","text":" #1","isSubtle":true,"size":"Medium"}],"spacing":"None"}],"verticalContentAlignment":"Center"}]},{"type":"TextBlock","text":"","fontType":"Monospace","wrap":true,"maxLines":2},{"type":"RichTextBlock","inlines":[]}],"actions":[],"authentication":{"text":"Please login to GitHub","connectionName":"GitConnection","buttons":[{"type":"signin","title":"Signin","text":"Please login to GitHub","value":"https://token.botframework.com/api/oauth/signin?signin=cf933d0ca8994ac1a64ab2f350fd7651"}]}}})";
        std::string x{ response };

        // post-process response
        auto y{ x.substr(51, x.length() - 51 - 1) };
