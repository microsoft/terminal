...
namespace winrt::Microsoft::Terminal::TerminalControl::implementation
{
    ...
    TermControlTwo::TermControlTwo(IControlSettings settings,
    ...
    void TermControlTwo::CreateSearchBoxControl()
    {
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_CloseSearchBoxControl(const winrt::Windows::Foundation::IInspectable& /*sender*/,
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_UpdateSettingsOnUIThread()
    {
        if (_closing)
        {
            return;
    ...
    // Return Value:
    // - <none>
    winrt::fire_and_forget TermControlTwo::UpdateSettings()
    {
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_ApplyUISettings(const IControlSettings& newSettings)
    {
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_InitializeBackgroundBrush()
    {
    ...
    Windows::UI::Xaml::Automation::Peers::AutomationPeer TermControlTwo::OnCreateAutomationPeer()
    try
    {
        // TODO:MG - This can just be hooked back up once this is TermControl again.
        //
    ...
    void TermControlTwo::_AttachDxgiSwapChainToXaml(HANDLE swapChainHandle)
    {
    ...
    void TermControlTwo::_CharacterHandler(winrt::Windows::Foundation::IInspectable const& /*sender*/,
    ...
    bool TermControlTwo::OnDirectKeyEvent(const uint32_t vkey, const uint8_t scanCode, const bool down)
    {
    ...
    void TermControlTwo::_KeyDownHandler(winrt::Windows::Foundation::IInspectable const& /*sender*/,
                                         Input::KeyRoutedEventArgs const& e)
    {
        _KeyHandler(e, true);
    }

    void TermControlTwo::_KeyUpHandler(winrt::Windows::Foundation::IInspectable const& /*sender*/,
                                       Input::KeyRoutedEventArgs const& e)
    {
        _KeyHandler(e, false);
    }

    void TermControlTwo::_KeyHandler(Input::KeyRoutedEventArgs const& e, const bool keyDown)
    {
    ...
    bool TermControlTwo::_TryHandleKeyBinding(const WORD vkey, const WORD scanCode, ::Microsoft::Terminal::Core::ControlKeyStates modifiers) const
    {
        auto bindings = _settings.KeyBindings();
        if (!bindings)
        {
    ...
    // - vkey: The vkey of the key pressed.
    // - scanCode: The scan code of the key pressed.
    void TermControlTwo::_ClearKeyboardState(const WORD vkey, const WORD scanCode) const noexcept
    {
    ...
    bool TermControlTwo::_TrySendKeyEvent(const WORD vkey,
                                          const WORD scanCode,
    ...
    // - args: event data
    void TermControlTwo::_TappedHandler(const IInspectable& /*sender*/, const TappedRoutedEventArgs& e)
    {
    ...
    bool TermControlTwo::_TrySendMouseEvent(Windows::UI::Input::PointerPoint const& point)
    {
    ...
    // - args: event data
    void TermControlTwo::_PointerPressedHandler(Windows::Foundation::IInspectable const& sender,
    ...
    // - sender: not used
    // - args: event data
    void TermControlTwo::_PointerMovedHandler(Windows::Foundation::IInspectable const& /*sender*/,
                                              Input::PointerRoutedEventArgs const& args)
    {
        if (_closing)
        {
    ...
    // - sender: the XAML element responding to the pointer input
    // - args: event data
    void TermControlTwo::_PointerReleasedHandler(Windows::Foundation::IInspectable const& sender,
                                                 Input::PointerRoutedEventArgs const& args)
    {
        if (_closing)
        {
    ...
    void TermControlTwo::_MouseWheelHandler(Windows::Foundation::IInspectable const& /*sender*/,
                                            Input::PointerRoutedEventArgs const& args)
    {
        if (_closing)
        {
    ...
    bool TermControlTwo::_DoMouseWheel(const Windows::Foundation::Point point,
                                       const ControlKeyStates modifiers,
                                       const int32_t delta,
    ...
    bool TermControlTwo::OnMouseWheel(const Windows::Foundation::Point location,
                                      const int32_t delta,
    ...
    void TermControlTwo::_MouseTransparencyHandler(const double mouseDelta)
    {
    ...
    // Arguments:
    // - mouseDelta: the mouse wheel delta that triggered this event.
    void TermControlTwo::_MouseZoomHandler(const double mouseDelta)
    {
    ...
    // Arguments:
    // - none
    void TermControlTwo::ResetFontSize()
    {
    ...
    void TermControlTwo::AdjustFontSize(int fontSizeDelta)
    {
        const auto newSize = _core->_desiredFont.GetEngineSize().Y + fontSizeDelta;
    ...
    void TermControlTwo::_MouseScrollHandler(const double mouseDelta,
    ...
    void TermControlTwo::_ScrollbarChangeHandler(Windows::Foundation::IInspectable const& /*sender*/,
    ...
    bool TermControlTwo::_CapturePointer(Windows::Foundation::IInspectable const& sender, Windows::UI::Xaml::Input::PointerRoutedEventArgs const& args)
    {
        IUIElement uielem;
    ...
    bool TermControlTwo::_ReleasePointerCapture(Windows::Foundation::IInspectable const& sender, Windows::UI::Xaml::Input::PointerRoutedEventArgs const& args)
    {
        IUIElement uielem;
        if (sender.try_as(uielem))
        {
    ...
    void TermControlTwo::_TryStartAutoScroll(Windows::UI::Input::PointerPoint const& pointerPoint, const double scrollVelocity)
    {
    ...
    void TermControlTwo::_TryStopAutoScroll(const uint32_t pointerId)
    {
    ...
    // Arguments:
    // - none
    void TermControlTwo::_UpdateAutoScroll(Windows::Foundation::IInspectable const& /* sender */,
    ...
    //   - enable accessibility notifications for this TermControlTwo
    //   - start blinking the cursor when the window is focused
    //   - update the number of lines to scroll to the value set in the system
    void TermControlTwo::_GotFocusHandler(Windows::Foundation::IInspectable const& /* sender */,
                                          RoutedEventArgs const& /* args */)
    {
        if (_closing)
        {
    ...
    void TermControlTwo::_UpdateSystemParameterSettings() noexcept
    {
    ...
    //   - disable accessibility notifications for this TermControlTwo
    //   - hide and stop blinking the cursor when the window loses focus.
    void TermControlTwo::_LostFocusHandler(Windows::Foundation::IInspectable const& /* sender */,
                                           RoutedEventArgs const& /* args */)
    {
        if (_closing)
        {
    ...
    void TermControlTwo::_SwapChainSizeChanged(winrt::Windows::Foundation::IInspectable const& /*sender*/,
    ...
    // - sender: not used
    // - e: not used
    void TermControlTwo::_BlinkTimerTick(Windows::Foundation::IInspectable const& /* sender */,
                                         Windows::Foundation::IInspectable const& /* e */)
    {
        if (!_closing)
        {
    ...
    void TermControlTwo::PasteTextFromClipboard()
    {
        // attach TermControlTwo::_SendInputToConnection() as the clipboardDataHandler.
        // This is called when the clipboard data is loaded.
        auto clipboardDataHandler = std::bind(&TermControlTwo::_SendPastedTextToConnection, this, std::placeholders::_1);
    ...
    void TermControlTwo::ScrollViewport(int viewTop)
    {
    ...
    winrt::Windows::Foundation::Size TermControlTwo::GetProposedDimensions(IControlSettings const& settings, const uint32_t dpi)
    {
    ...
    // Return Value:
    // - a size containing the requested dimensions in pixels.
    winrt::Windows::Foundation::Size TermControlTwo::GetProposedDimensions(const winrt::Windows::Foundation::Size& initialSizeInChars,
    ...
    winrt::Windows::Foundation::Size TermControlTwo::MinimumSize()
    {
        if (_initializedTerminal)
        {
            const auto fontSize = _core->_actualFont.GetSize();
    ...
    //   Used for controlling the TermControlTwo XAML Grid container's Padding prop.
    // Arguments:
    ...
    Windows::UI::Xaml::Thickness TermControlTwo::_ParseThicknessFromPadding(const hstring padding)
    {
    ...
    ControlKeyStates TermControlTwo::_GetPressedModifierKeys() const
    {
        const CoreWindow window = CoreWindow::GetForCurrentThread();
        // DONT USE
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_CompositionCompleted(winrt::hstring text)
    {
        if (_closing)
        {
            return;
    ...
    // - otherwise, 1
    const unsigned int TermControlTwo::_NumberOfClicks(winrt::Windows::Foundation::Point clickPos, Timestamp clickTime)
    {
    ...
    double TermControlTwo::_GetAutoScrollSpeed(double cursorDistanceFromBorder) const
    {
    ...
    // Return Value:
    // - <none>
    winrt::fire_and_forget TermControlTwo::_DragDropHandler(Windows::Foundation::IInspectable const& /*sender*/,
    ...
    // Return Value:
    // - <none>
    void TermControlTwo::_DragOverHandler(Windows::Foundation::IInspectable const& /*sender*/,
                                          DragEventArgs const& e)
    {
        if (_closing)
        {
    ...
    // Arguments:
    // - The uri
    winrt::fire_and_forget TermControlTwo::_HyperlinkHandler(const std::wstring_view uri)
    {
    ...
    winrt::fire_and_forget TermControlTwo::_RendererEnteredErrorState()
    {
        auto strongThis{ get_strong() };
    ...
    void TermControlTwo::_RenderRetryButton_Click(IInspectable const& /*sender*/, IInspectable const& /*args*/)
    {
    ...
    bool TermControlTwo::ReadOnly() const noexcept
    {
        return _isReadOnly;
    }
    ...
    void TermControlTwo::ToggleReadOnly()
    {
        _isReadOnly = !_isReadOnly;
        _ReadOnlyChangedHandlers(*this, winrt::box_value(_isReadOnly));
    }

    winrt::fire_and_forget TermControlTwo::_RaiseReadOnlyWarning()
    {
        auto weakThis{ get_weak() };
        co_await winrt::resume_foreground(Dispatcher());
