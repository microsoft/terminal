...
void TerminalCoreUnitTests::TerminalApiTest::SetTaskbarProgress()
{
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(0));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(0));

    // Set some values for taskbar state and progress through state machine
    stateMachine.ProcessString(L"\x1b]9;4;1;50\x1b\\");
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(1));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(50));
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(1));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(100));
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(1));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(80));
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(2));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(80));
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(3));
    VERIFY_ARE_EQUAL(term.GetTaskbarProgress(), wil::safe_cast<size_t>(80));
    ...
    VERIFY_ARE_EQUAL(term.GetTaskbarState(), wil::safe_cast<size_t>(2));
    VERIFY_IS_GREATER_THAN(term.GetTaskbarProgress(), wil::safe_cast<size_t>(0));
}
