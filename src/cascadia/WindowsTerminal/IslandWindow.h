...
public:
    ...
    void SetCreateCallback(std::function<winrt::hstring(const HWND, const RECT)> pfn) noexcept;
...
protected:
    ...
    std::function<winrt::hstring(const HWND, const RECT)> _pfnCreateCallback;
