...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT UpdateDrawingBrushes(const TextAttribute& textAttributes, const RenderSettings& renderSettings, IRenderData* pData, const bool usingSoftFont, const bool isSettingDefaultBrushes) noexcept override;
