...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        void TriggerRedrawAll(const bool backgroundChanged = false, const bool tabChanged = false);
        ...
        void SetTabColorChangedCallback(std::function<void()> pfn);
    ...
    private:
        ...
        std::function<void()> _pfnTabColorChanged;
