...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT UpdateFont(const FontInfoDesired& fiFontInfoDesired, FontInfo& fiFontInfo, std::unordered_map<std::wstring_view, uint32_t> features, std::unordered_map<std::wstring_view, int32_t> axes) noexcept;
