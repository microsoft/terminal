...
namespace Microsoft::Console::Render
{
    ...
    private:
        ...
        [[nodiscard]] HRESULT _ScaleByFont(const til::point pcoord, _Out_ POINT* const pPoint) const noexcept;
        [[nodiscard]] HRESULT _ScaleByFont(const til::rect* const psr, _Out_ RECT* const prc) const noexcept;
        [[nodiscard]] HRESULT _ScaleByFont(const RECT* const prc, _Out_ til::inclusive_rect* const psr) const noexcept;
