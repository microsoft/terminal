...
namespace Microsoft::Console::Render::Atlas
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT UpdateDrawingBrushes(const TextAttribute& textAttributes, const RenderSettings& renderSettings, IRenderData* pData, bool usingSoftFont, bool isSettingDefaultBrushes) noexcept override;
