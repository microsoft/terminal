...
#pragma warning(suppress : 26432) // If you define or delete any default operation in the type '...', define or delete them all (c.21).
        ...
        [[nodiscard]] virtual HRESULT Invalidate(const til::rect* const psrRegion) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateCursor(const til::rect* const psrRegion) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateSystem(const til::rect* const prcDirtyClient) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateSelection(const std::vector<til::rect>& rectangles) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateScroll(til::point pcoordDelta) noexcept = 0;
        ...
        [[nodiscard]] virtual HRESULT PaintBufferGridLines(GridLineSet lines, COLORREF color, size_t cchLine, const til::point coordTarget) noexcept = 0;
        ...
        [[nodiscard]] virtual HRESULT GetFontSize(_Out_ til::size* const pFontSize) noexcept = 0;
