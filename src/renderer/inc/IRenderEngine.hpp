...
#pragma warning(suppress : 26432) // If you define or delete any default operation in the type '...', define or delete them all (c.21).
        ...
        [[nodiscard]] virtual HRESULT UpdateDrawingBrushes(const TextAttribute& textAttributes, const RenderSettings& renderSettings, IRenderData* pData, bool usingSoftFont, bool isSettingDefaultBrushes) noexcept = 0;
