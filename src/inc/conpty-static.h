...
#ifndef PSEUDOCONSOLE_AMBIGUOUS_WIDTH__MASK
#define PSEUDOCONSOLE_AMBIGUOUS_WIDTH__MASK 0x60
#define PSEUDOCONSOLE_AMBIGUOUS_WIDTH_NARROW 0x20
#define PSEUDOCONSOLE_AMBIGUOUS_WIDTH_WIDE 0x40
#endif
