...
#define COMMON_HAX_USE_ALT_META_MEANINGS 0x2000 // this unused bit lets us change what the LVB grid line attrs mean
#define COMMON_HAX_META_FG_DEFAULT 0x0800 
#define COMMON_HAX_META_BG_DEFAULT 0x1000 
#define COMMON_HAX_META_UNUSED 0x8000
#define COMMON_HAX_MASK 0xB800 // don't pollute the LVB range
...
#define META_ATTRS (COMMON_HAX_MASK | COMMON_LVB_LEADING_BYTE | COMMON_LVB_TRAILING_BYTE | COMMON_LVB_GRID_HORIZONTAL | COMMON_LVB_GRID_LVERTICAL | COMMON_LVB_GRID_RVERTICAL | COMMON_LVB_REVERSE_VIDEO | COMMON_LVB_UNDERSCORE)
