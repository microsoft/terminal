...
void Utf8Utf16ConvertTests::TestU8ToU16()
{
    ...
    const std::wstring u16StringComp{
        til::narrow_cast<wchar_t>(0x007eU), // TILDE
        til::narrow_cast<wchar_t>(0x00f6U), // LATIN SMALL LETTER O WITH DIAERESIS
        til::narrow_cast<wchar_t>(0x20acU), // EURO SIGN
        til::narrow_cast<wchar_t>(0xd853U), // CJK UNIFIED IDEOGRAPH-24F5C (surrogate pair)
        til::narrow_cast<wchar_t>(0xdf5cU)
    };
...
void Utf8Utf16ConvertTests::TestU8ToU16Partials()
{
    ...
    const std::wstring u16StringComp1{
        til::narrow_cast<wchar_t>(0xD853), // CJK UNIFIED IDEOGRAPH-24F5C (surrogate pair)
        til::narrow_cast<wchar_t>(0xDF5C)
    };
    ...
    const std::wstring u16StringComp2{
        til::narrow_cast<wchar_t>(0x263A) // WHITE SMILING FACE
    };
...
void Utf8Utf16ConvertTests::TestU16ToU8Partials()
{
    const std::wstring u16String1{
        til::narrow_cast<wchar_t>(0xD853), // CJK UNIFIED IDEOGRAPH-24F5C (surrogate pair)
        til::narrow_cast<wchar_t>(0xDF5C),
        til::narrow_cast<wchar_t>(0xD853) // CJK UNIFIED IDEOGRAPH-24F5C (high surrogate only)
    };

    const std::wstring u16String2{
        til::narrow_cast<wchar_t>(0xDF5C) // CJK UNIFIED IDEOGRAPH-24F5C (low surrogate only)
    };
...
void Utf8Utf16ConvertTests::TestU8ToU16OneByOne()
{
    ...
    const std::wstring u16StringComp1{
        til::narrow_cast<wchar_t>(0xD83D), // U+1F4F7 CAMERA (surrogate pair)
        til::narrow_cast<wchar_t>(0xDCF7)
    };
