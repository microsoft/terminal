...
namespace Microsoft::Console::VirtualTerminal
{
    ...
    private:
        ...
        bool _EraseAll();
        bool _InsertDeleteHelper(const VTInt count, const bool isInsert) const;
        bool _ScrollMovement(const ScrollDirection dir, const VTInt distance) const;

        bool _DoSetTopBottomScrollingMargins(const VTInt topMargin,
