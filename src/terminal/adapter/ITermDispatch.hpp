...
#pragma warning(disable : 26432) // suppress rule of 5 violation on interface because tampering with this is fraught with peril
    ...
    virtual bool Designate94Charset(const size_t gsetNumber, const wchar_t charset) = 0; // SCS
    virtual bool Designate96Charset(const size_t gsetNumber, const wchar_t charset) = 0; // SCS
