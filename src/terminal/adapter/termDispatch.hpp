...
public:
    ...
    bool SelectiveEraseInDisplay(const DispatchTypes::EraseType /*eraseType*/) { return false; } // DECSED
    bool SelectiveEraseInLine(const DispatchTypes::EraseType /*eraseType*/) { return false; } // DECSEL
