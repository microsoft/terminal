...
public:
    ...
    bool Designate94Charset(const size_t /*gsetNumber*/, const wchar_t /*charset*/) noexcept override { return false; } // SCS
    bool Designate96Charset(const size_t /*gsetNumber*/, const wchar_t /*charset*/) noexcept override { return false; } // SCS
