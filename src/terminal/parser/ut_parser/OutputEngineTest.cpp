...
public:
    ...
    void SetDefaultForeground(const DWORD color) noexcept override
    {
        _setDefaultForeground = true;
        _defaultForegroundColor = color;
    }

    void SetDefaultBackground(const DWORD color) noexcept override
    {
        _setDefaultBackground = true;
        _defaultBackgroundColor = color;
    }

    void SetCursorColor(const DWORD color) noexcept override
    {
