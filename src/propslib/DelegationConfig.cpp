...
try
{
    ...
    RETURN_IF_NTSTATUS_FAILED(RegistrySerialization::s_SetValue(startupKey.get(), value, REG_SZ, reinterpret_cast<BYTE*>(str.get()), wil::safe_cast<DWORD>(wcslen(str.get()) * sizeof(wchar_t))));
