...
class ApiRoutinesTests
{
    ...
    TEST_METHOD(ApiGetConsoleTitleW)
    {
        ...
        VERIFY_ARE_EQUAL(WEX::Common::String(title.data(), til::narrow_cast<int>(title.size())), WEX::Common::String(pwszTitle));
    }
    ...
    TEST_METHOD(ApiGetConsoleOriginalTitleA)
    {
        ...
        const auto iBytesNeeded = WideCharToMultiByte(gci.OutputCP,
                                                      0,
                                                      originalTitle.data(),
                                                      til::narrow_cast<int>(originalTitle.size()),
                                                      nullptr,
                                                      0,
                                                      nullptr,
                                                      nullptr);
    ...
    TEST_METHOD(ApiGetConsoleOriginalTitleW)
    {
        ...
        VERIFY_ARE_EQUAL(WEX::Common::String(originalTitle.data(), til::narrow_cast<int>(originalTitle.size())), WEX::Common::String(pwszTitle));
    }
