...
public:
    ...
    Popup(SCREEN_INFORMATION& screenInfo, const til::point proposedSize);
    virtual ~Popup();
...
private:
    til::point _CalculateSize(const SCREEN_INFORMATION& screenInfo, const til::point proposedSize);
    til::point _CalculateOrigin(const SCREEN_INFORMATION& screenInfo, const til::point size);
