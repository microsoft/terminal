...
void BufferTests::TestWritingInactiveScreenBuffer()
{
    ...
    VERIFY_WIN32_BOOL_SUCCEEDED(WriteConsoleW(out, primary.data(), wil::safe_cast<DWORD>(primary.size()), &written, nullptr));
    ...
    written = 0;
    VERIFY_WIN32_BOOL_SUCCEEDED(WriteConsoleW(out, newline.data(), wil::safe_cast<DWORD>(newline.size()), &written, nullptr));
    ...
    written = 0;
    VERIFY_WIN32_BOOL_SUCCEEDED(WriteConsoleW(handle, alternative.data(), wil::safe_cast<DWORD>(alternative.size()), &written, nullptr));
    ...
    DWORD read = 0;
    VERIFY_WIN32_BOOL_SUCCEEDED(ReadConsoleOutputCharacterW(out, primaryBuffer.get(), wil::safe_cast<DWORD>(primary.size()), { 0, 0 }, &read));
    VERIFY_ARE_EQUAL(primary.size(), read);
    VERIFY_ARE_EQUAL(String(primary.data()), String(primaryBuffer.get(), wil::safe_cast<int>(primary.size())));
    ...
    read = 0;
    VERIFY_WIN32_BOOL_SUCCEEDED(ReadConsoleOutputCharacterW(out, alternativeBuffer.get(), wil::safe_cast<DWORD>(alternative.size()), { 0, 1 }, &read));
    VERIFY_ARE_EQUAL(alternative.size(), read);
    VERIFY_ARE_EQUAL(String(alternativeExpected.data()), String(alternativeBuffer.get(), wil::safe_cast<int>(alternative.size())));
    ...
    read = 0;
    VERIFY_WIN32_BOOL_SUCCEEDED(ReadConsoleOutputCharacterW(handle, alternativeBuffer.get(), wil::safe_cast<DWORD>(alternative.size()), { 0, 0 }, &read));
    VERIFY_ARE_EQUAL(alternative.size(), read);
    VERIFY_ARE_EQUAL(String(alternative.data()), String(alternativeBuffer.get(), wil::safe_cast<int>(alternative.size())));
}
