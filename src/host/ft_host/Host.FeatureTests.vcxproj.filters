...
<Project ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemGroup>
    ...
    <Filter Include="Source Files\API">
      <UniqueIdentifier>{ff4de03f-e6e3-44a0-9a53-06d0b3943469}</UniqueIdentifier>
    </Filter>
    <Filter Include="Source Files\Message">
      <UniqueIdentifier>{ac4e9c27-4849-46e8-bd03-0af91bcb6a87}</UniqueIdentifier>
    </Filter>
    <Filter Include="Source Files\CJK">
      <UniqueIdentifier>{f4d0ca10-abd1-4469-b871-ffc5098754e3}</UniqueIdentifier>
    </Filter>
  </ItemGroup>
  <ItemGroup>
    ...
    <ClCompile Include="CJK_DbcsTests.cpp">
      <Filter>Source Files\CJK</Filter>
    </ClCompile>
