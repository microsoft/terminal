...
| `antialiasingMode` | Optional | String | `"grayscale"` | Controls how text is antialiased in the renderer. Possible values are "grayscale" and "cleartype". Note that changing this setting will require starting a new terminal instance. |
