...
| `rowsToScroll` | Optional | Integer | `null` | The number of rows to scroll at a time with the mouse wheel. This will override the system setting if the value is specified and is not 0 or null. |
