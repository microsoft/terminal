...
| `confirmCloseTab` | Optional | Boolean | `true` | When set to `true` closing a tab with multiple panes open will require confirmation.  When set to `false`, the confirmation dialog will not appear. |
