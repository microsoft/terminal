...
In [#3369](https://github.com/microsoft/terminal/pull/3369), we introduced the
...
14 as their `fontSize`. With `defaultSettings`, you can easily set these
...
value from `defaultSettings`. Let's say you want the `cmd` profile to have
`Consolas` as the font, but the rest of your profiles to still have "Cascadia
Code". You could achieve that with the following:
