      ...
      <Application Id="App" ... >
        ...
        <Extensions>
          ...
          <uap3:Extension Category="windows.appExtension">
            <uap3:AppExtension Name="com.Microsoft.Terminal"
                               Id="<id>"
                               PublicFolder="Public">
            </uap3:AppExtension>
          </uap3:Extension>
...
Note that the name field **must** be `com.Microsoft.Terminal` for us to detect this extension. The `Id` field
...
During our profile generation, we will probe the OS for app extensions with the name `com.Microsoft.Terminal`
