...
* You must be running Windows 1903 (build >= 10.0.18362.0) or above in order to run Windows Terminal
  - **As of May 2019** this build is only available through Windows Insider Program. You may register, setup, and configure the Insider Program through your device's system settings.
